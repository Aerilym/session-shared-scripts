...
def matches_braced_pattern(string: str) -> bool:
    """Check if string contains a braced placeholder pattern."""
...
def get_output_locale(locale: str, two_letter_code: str) -> str:
    """Get the output locale path for a given input locale."""
...
def generate_typescript_constants(
    ...
    """Generate TypeScript file with non-translatable string constants."""
